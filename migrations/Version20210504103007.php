 ...
 */
final class Version20210504103007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE result (id INT AUTO_INCREMENT NOT NULL, team_id INT NOT NULL, game_id INT NOT NULL, INDEX IDX_136AC113296CD8AE (team_id), INDEX IDX_136AC113E48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE result ADD CONSTRAINT FK_136AC113296CD8AE FOREIGN KEY (team_id) REFERENCES `group` (id)');
